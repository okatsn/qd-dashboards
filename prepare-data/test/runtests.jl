...
@testset "DocTests" begin
    DocMeta.setdocmeta!(PrepareData, :DocTestSetup, :(using PrepareData); recursive=true)
    # using the package everywhere in the doc
    # See also https://documenter.juliadocs.org/stable/man/doctests/#Setup-Code


    doctest(PrepareData; manual = false) # this makes jldoctest also be tested in a local test
end
